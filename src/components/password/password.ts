...
export default class Password extends Block<PasswordProps, PasswordChildren> {
  ...
  init() {
    ...
    const OldPasswordInput = new ProfileField({
      title: 'Старый пароль', name: 'oldPassword', type: 'password', onBlur: onChangeBind,
    });
    const NewPasswordInput = new ProfileField({
      title: 'Новый пароль', name: 'newPassword', onBlur: onChangeBind, type: 'password',
    });
    const ConfirmNewPasswordInput = new ProfileField({
      title: 'Повторите новый пароль', name: 'confirmNewPassword', onBlur: onChangeBind, type: 'password',
    });
